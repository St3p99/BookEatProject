...
class DeleteReservationHandler extends StatefulWidget{
  ...
  @override
  _DeleteReservationHandlerState createState() => _DeleteReservationHandlerState();
}
      ...
      child: IconButton(
        onPressed: () {
          CoolAlert.show(
              ...
              title: AppLocalizations.of(context).translate("delete_reservation").toUpperCase()+"!",
              text: AppLocalizations.of(context).translate("delete_reservation_text").toUpperCase(),
              confirmBtnText: AppLocalizations.of(context).translate("yes").toUpperCase(),
              cancelBtnText: "NO",
              onConfirmBtnTap: () {
                _deleteReservation();
                widget.notifyParent();
